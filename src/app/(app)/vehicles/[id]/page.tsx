    ...
    <div className="mx-auto flex max-w-2xl flex-col gap-8">
      <div className="flex flex-col gap-5">
        ...
        <div className="flex flex-col gap-2 rounded-xl border border-foreground/10 p-4">
            ...
            <ul className="flex flex-col gap-2">
              {activeNotes.map((n) => (
                ...
                >
                  ...
                  <form action={resolveVehicleNote.bind(null, vehicle.id, n.id)} className="shrink-0">
          ...
          <form action={addVehicleNote.bind(null, vehicle.id)} className="flex flex-col gap-2 sm:flex-row sm:items-start">
            <textarea
              name="text"
              required
              rows={2}
