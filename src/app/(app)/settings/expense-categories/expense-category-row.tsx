...
import { toggleExpenseCategory, deleteExpenseCategory, moveExpenseCategory } from "./actions";
    ...
    return (
      <li className="flex items-center justify-between gap-3 bg-red-500/5 px-3 py-2">
        <span className="text-sm text-red-700 dark:text-red-400">
          ¿Borrar &quot;{item.name}&quot;? Los gastos ya cargados con esta categoría la conservan igual. No se puede
          deshacer.
        </span>
  ...
  return (
    <li className="flex flex-col gap-1 px-3 py-2">
      <div className="flex items-center gap-2">
        ...
        <form action={toggleExpenseCategory.bind(null, item.id)}>
