...
/** Alfiler de "fijar" — relleno cuando está fijado, contorno cuando no (fijado propio de Andes en WhatsApp). */
export function PinIcon({ filled = false, className = "size-4" }: { filled?: boolean; className?: string }) {
  return (
    <svg
      viewBox="0 0 24 24"
      ...
      className={className}
    >
      <path d="M12 2a5 5 0 0 0-5 5c0 3 2 4.5 2 6.5H8l-2 2.5h12l-2-2.5h-1c0-2 2-3.5 2-6.5a5 5 0 0 0-5-5Z" />
      <path d="M12 16.5V22" />
    </svg>
  );
}
